...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'form',
        { onSubmit: this.settingsChanged },
        React.createElement(
          'label',
          null,
          'Inhale: ',
          React.createElement('input', { type: 'number', step: 'any', defaultValue: this.state.inhaleDuration, ref: 'inhaleDuration' }),
          ' '
        ),
        ...
        React.createElement(
          ...
          null,
          'Inhale Pause: ',
          React.createElement('input', { type: 'number', step: 'any', defaultValue: this.state.inhaleHoldDuration, ref: 'inhaleHoldDuration' }),
          ' '
        ),
        React.createElement('br', null),
        React.createElement(
          ...
          null,
          'Exhale: ',
          React.createElement('input', { type: 'number', step: 'any', defaultValue: this.state.exhaleDuration, ref: 'exhaleDuration' }),
          ' '
        ),
        React.createElement('br', null),
        React.createElement(
          ...
          null,
          'Exhale Pause: ',
          React.createElement('input', { type: 'number', step: 'any', defaultValue: this.state.exhaleHoldDuration, ref: 'exhaleHoldDuration' }),
          ' '
        ),
